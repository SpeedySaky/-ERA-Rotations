...
public class EraBearDruid : Rotation
{
    ...
    public override bool PassivePulse()
    {
        ...
        if (Api.Spellbook.CanCast("Attack") && target.IsValid() && !target.IsDead() && (reaction != UnitReaction.Friendly && reaction != UnitReaction.Honored && reaction != UnitReaction.Revered && reaction != UnitReaction.Exalted) && !IsNPC(target))
        {
            Console.ForegroundColor = ConsoleColor.Green;
