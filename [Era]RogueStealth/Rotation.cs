...
public class RogueStealth : Rotation
{
    ...
    public override bool CombatPulse()
    {
        ...
        if (Api.Spellbook.CanCast("Adrenaline Rush") && !Api.Spellbook.OnCooldown("Adrenaline Rush") && Api.UnitsTargetingMe(5, true).Length >= 2)
        {
            Console.ForegroundColor = ConsoleColor.Green;
        ...
        if (Api.Spellbook.CanCast("Evasion") && Api.UnitsTargetingMe(5, true).Length >= 2 && !Api.Spellbook.OnCooldown("Evasion"))
        {
            Console.ForegroundColor = ConsoleColor.Green;
        ...
        if (Api.Spellbook.HasSpell("Blade Flurry") && Api.UnitsTargetingMe(5, true).Length >= 2 && !Api.Spellbook.OnCooldown("Blade Flurry") && energy >= 25)
        {
            Console.ForegroundColor = ConsoleColor.Green;
